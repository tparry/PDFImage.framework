...
- (void)testPDFImageResultCache
{
	...
	options.contentMode = UIViewContentModeTopLeft;
...
- (void)testPDFImageOptionsContentMode
{
	...
	PDFImageOptions *options = [PDFImageOptions new];
	options.size = containerSize;

	options.contentMode = UIViewContentModeScaleToFill;
	...
	options.contentMode = UIViewContentModeScaleAspectFill;
	...
	options.contentMode = UIViewContentModeRedraw;
	XCTAssertTrue(CGRectEqualToRect(CGRectMake(0, 0, 20, 20), [options contentBoundsForContentSize:contentSize]), @"Wrong content mode bounds");

	options.contentMode = UIViewContentModeCenter;
	...
	options.contentMode = UIViewContentModeTop;
	...
	options.contentMode = UIViewContentModeBottom;
	...
	options.contentMode = UIViewContentModeLeft;
	...
	options.contentMode = UIViewContentModeRight;
	...
	options.contentMode = UIViewContentModeTopRight;
	...
	options.contentMode = UIViewContentModeBottomLeft;
	...
	options.contentMode = UIViewContentModeBottomRight;
...
- (void)testPDFImageView
{
	...
	UIImageView *privateImageView = imageView.subviews.firstObject;
